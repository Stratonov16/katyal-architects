...
export default async function CareersPage() {
  ...
  const perks = [
    ...
    { icon: "M16 21v-2a4 4 0 0 0-4-4H6a4 4 0 0 0-4 4v2 M9 7a4 4 0 1 1 0 0 M23 21v-2a4 4 0 0 0-3-3.87", title: "Close-knit Studio", desc: "Learn directly from the principal architect, every day." },
      ...
      <main className="min-h-screen pt-14">
        ...
        <section className="relative overflow-hidden px-8 pt-24 pb-20 text-center">
          ...
          <div className="pointer-events-none absolute inset-0 -z-10 flex items-start justify-center">
            <div className="w-[60vw] h-[60vw] max-w-[700px] max-h-[700px] rounded-full bg-[var(--review-accent)] opacity-[0.07] blur-[120px]" />
          </div>

          <p className="career-rise text-[10px] uppercase tracking-[0.4em] text-[var(--review-accent)] mb-5" style={{ animationDelay: "0s" }}>
            Careers at Katyal Architects
          </p>
          ...
          <div className="career-rise grid grid-cols-1 sm:grid-cols-3 gap-4 max-w-4xl mx-auto mt-14 text-left" style={{ animationDelay: "0.32s" }}>
            {perks.map((p) => (
              <div key={p.title} className="perk-tile p-6">
                <div className="w-10 h-10 rounded-full flex items-center justify-center mb-4 bg-[var(--review-accent)]/10 text-[var(--review-accent)]">
        ...
        <section className="px-8 pb-24">
          <div className="max-w-4xl mx-auto">
            <div className="flex items-center gap-4 mb-10">
              ...
              <span className="text-[10px] uppercase tracking-[0.15em] text-[var(--review-accent)] border border-[var(--review-accent)]/40 rounded-full px-3 py-1">
                {jobs.length} open
              </span>
            ...
            {jobs.length > 0 ? (
                  ...
                  >
                    <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
                      <div>
                        ...
                        <div className="flex flex-wrap gap-2 mt-3">
                          {job.department && (
                            <span className="text-[9px] uppercase tracking-[0.1em] px-2.5 py-1 rounded-full bg-[var(--review-accent)]/10 text-[var(--review-accent)]">{job.department}</span>
                          )}
                          {job.location && (
                    ...
                    {job.requirements && (
                      <div className="mt-5 pt-5 border-t border-[var(--border)]">
                        <p className="text-[9px] uppercase tracking-[0.2em] text-[var(--review-accent)] mb-2">Requirements</p>
              ...
              <div className="career-card text-center py-16 px-6">
                <div className="w-12 h-12 mx-auto mb-4 rounded-full flex items-center justify-center bg-[var(--review-accent)]/10 text-[var(--review-accent)]">
                ...
                <p className="text-sm text-[var(--text-muted)] max-w-sm mx-auto">
                  ...
                  <a href="mailto:info@katyalarchitects.com" className="text-[var(--review-accent)] hover:underline">info@katyalarchitects.com</a>
                </p>
              </div>
            )}
